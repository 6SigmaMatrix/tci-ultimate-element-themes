...
class TCI_UET_Price_List extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Price List', 'tci-uet' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'price_list',
			[
				'label'       => __( 'List Items', 'tci-uet' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[
						'title'            => __( 'First item on the list', 'tci-uet' ),
						'item_description' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'tci-uet' ),
						'price'            => '$20',
						'link'             => [ 'url' => '#' ],
					],
					[
						'title'            => __( 'Second item on the list', 'tci-uet' ),
						'item_description' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'tci-uet' ),
						'price'            => '$9',
						'link'             => [ 'url' => '#' ],
					],
					[
						'title'            => __( 'Third item on the list', 'tci-uet' ),
						'item_description' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'tci-uet' ),
						'price'            => '$32',
						'link'             => [ 'url' => '#' ],
					],
