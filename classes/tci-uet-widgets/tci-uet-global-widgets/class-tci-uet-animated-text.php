...
class TCI_UET_Animated_Text extends Widget_Base {
	...
	protected function before_text_controls() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your title', 'tci-uet' ),
				'default'     => __( 'Before Text Here', 'tci-uet' ),
			]
		);
	}
	...
	protected function animated_text_controls() {
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Animated Text', 'tci-uet' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'after',
			]
		);
	...
	protected function after_text_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXTAREA,
				'placeholder' => __( 'Enter your title', 'tci-uet' ),
				'default'     => __( 'After Text Here', 'tci-uet' ),
			]
		);
	}
	...
	protected function js_controls() {
		...
		$this->add_control(
			...
			[
				'label'       => __( 'Next String Delay', 'tci-uet' ),
				'type'        => Controls_Manager::NUMBER,
