...
class TCI_UET_Nav_Menu extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Nav Menu', 'tci-uet' );
	}
	...
	public function get_script_depends() {
		return [ 'tci-uet-nav-menu', 'tci-uet-frontend' ];
	}
	...
	public function get_style_depends() {
		return [ 'font-awesome', 'tci-uet-frontend' ];
	}
	...
	protected function _register_controls() {
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				'menu',
				[
					'label'        => __( 'Menu', 'tci-uet' ),
					'type'         => Controls_Manager::SELECT,
					'options'      => $menus,
					'default'      => array_keys( $menus )[0],
					'save_default' => true,
					'separator'    => 'after',
					'description'  => sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'tci-uet' ), admin_url( 'nav-menus.php' ) ),
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf( __( '<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'tci-uet' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
					'separator'       => 'after',
		...
		$this->add_control(
			...
			[
				...
				'default'            => 'horizontal',
				'options'            => [
					'horizontal' => __( 'Horizontal', 'tci-uet' ),
					'vertical'   => __( 'Vertical', 'tci-uet' ),
					'dropdown'   => __( 'Dropdown', 'tci-uet' ),
				],
		...
		$this->add_control(
			'pointer',
			[
				'label'     => __( 'Pointer', 'tci-uet' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'underline',
				'options'   => [
					'none'        => __( 'None', 'tci-uet' ),
					'underline'   => __( 'Underline', 'tci-uet' ),
					'overline'    => __( 'Overline', 'tci-uet' ),
					'double-line' => __( 'Double Line', 'tci-uet' ),
					'framed'      => __( 'Framed', 'tci-uet' ),
					'background'  => __( 'Background', 'tci-uet' ),
		...
		$this->add_control(
			'indicator',
			[
				'label'        => __( 'Submenu Indicator', 'tci-uet' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'classic',
				'options'      => [
					'none'    => __( 'None', 'tci-uet' ),
					'classic' => __( 'Classic', 'tci-uet' ),
					'chevron' => __( 'Chevron', 'tci-uet' ),
					'angle'   => __( 'Angle', 'tci-uet' ),
					'plus'    => __( 'Plus', 'tci-uet' ),
				],
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Mobile Dropdown', 'tci-uet' ),
		...
		$this->add_control(
			'dropdown',
			[
				'label'        => __( 'Breakpoint', 'tci-uet' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'tablet',
				'options'      => [
					/* translators: %d: Breakpoint number. */
					'mobile' => sprintf( __( 'Mobile (< %dpx)', 'tci-uet' ), $breakpoints['md'] ),
					/* translators: %d: Breakpoint number. */
					'tablet' => sprintf( __( 'Tablet (< %dpx)', 'tci-uet' ), $breakpoints['lg'] ),
				],
		...
		$this->add_control(
			'full_width',
			[
				'label'              => __( 'Full Width', 'tci-uet' ),
				'type'               => Controls_Manager::SWITCHER,
				'description'        => __( 'Stretch the dropdown of the menu to full width.', 'tci-uet' ),
		...
		$this->add_control(
			...
			[
				...
				'default'      => 'aside',
				'options'      => [
					'aside'  => __( 'Aside', 'tci-uet' ),
					'center' => __( 'Center', 'tci-uet' ),
				],
		...
		$this->add_control(
			'toggle',
			[
				'label'              => __( 'Toggle Button', 'tci-uet' ),
				'type'               => Controls_Manager::SELECT,
				'default'            => 'burger',
				'options'            => [
					''       => __( 'None', 'tci-uet' ),
					'burger' => __( 'Hamburger', 'tci-uet' ),
				],
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Pointer Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => [
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_4,
		...
		$this->add_control(
			'pointer_width',
			[
				'label'     => __( 'Pointer Width', 'tci-uet' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Horizontal Padding', 'tci-uet' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 50,
		...
		$this->add_control(
			...
			[
				'raw'             => __( 'On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'tci-uet' ),
				'type'            => Controls_Manager::RAW_HTML,
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'menu-toggle' ); ?>>
			...
			<span class="elementor-screen-only"><?php _e( 'Menu', 'tci-uet' ); ?></span>
		</div>
