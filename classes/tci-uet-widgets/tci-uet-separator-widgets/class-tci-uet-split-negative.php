<?php
/**
 * TCI UET Split Negative Separator widget class
 *
...
class TCI_UET_Split_Negative extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Split Negative', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-split-negative.svg' ); ?></div>
		</div>
		<?php
	}
}
