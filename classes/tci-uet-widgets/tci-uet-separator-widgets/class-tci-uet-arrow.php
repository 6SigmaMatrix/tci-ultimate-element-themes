<?php
/**
 * TCI UET Arrow Separator widget class
 *
...
class TCI_UET_Arrow extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Arrow', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-arrow.svg' ); ?></div>
		</div>
		<?php
	}
}
