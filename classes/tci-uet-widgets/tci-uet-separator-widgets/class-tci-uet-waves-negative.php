<?php
/**
 * TCI UET Waves Negative Separator widget class
 *
...
class TCI_UET_Waves_Negative extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Waves Negative', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-waves-negative.svg' ); ?></div>
		</div>
		<?php
	}
}
