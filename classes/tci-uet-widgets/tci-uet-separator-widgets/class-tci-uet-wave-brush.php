<?php
/**
 * TCI UET Wave Brush Separator widget class
 *
...
class TCI_UET_Wave_Brush extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Wave Brush', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-wave-brush.svg' ); ?></div>
		</div>
		<?php
	}
}
