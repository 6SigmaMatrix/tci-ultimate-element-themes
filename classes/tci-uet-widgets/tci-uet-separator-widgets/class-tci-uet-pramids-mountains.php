<?php
/**
 * TCI UET Pramids Mountains Separator widget class
 *
...
class TCI_UET_Pramids_Mountains extends Widget_Base {
	...
	public function get_name() {
		return 'TCI_UET_Pramids_Mountains';
	}
	...
	public function get_title() {
		return __( 'TCI UET Pramids Mountains', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-pramids-mountains.svg' ); ?></div>
		</div>
		<?php
	}
}
