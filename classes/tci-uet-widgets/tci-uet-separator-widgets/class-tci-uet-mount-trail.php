<?php
/**
 * TCI UET Mount Trail Separator widget class
 *
...
class TCI_UET_Mount_Trail extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Mount Trail', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-mount-trail.svg' ); ?></div>
		</div>
		<?php
	}
}
