<?php
/**
 * TCI UET Opacity Tilt Separator widget class
 *
...
class TCI_UET_Opacity_Tilt extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Opacity Tilt', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-opacity-tilt.svg' ); ?></div>
		</div>
		<?php
	}
}
