<?php
/**
 * TCI UET Cristal Cap Separator widget class
 *
...
class TCI_UET_Cristal_Cap extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Cristal Cap', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-cristal-cap.svg' ); ?></div>
		</div>
		<?php
	}
}
