<?php
/**
 * TCI UET Book Negative widget class
 *
...
class TCI_UET_Book_Negative extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Book Negative', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-book-negative.svg' ); ?></div>
		</div>
		<?php
	}
}
