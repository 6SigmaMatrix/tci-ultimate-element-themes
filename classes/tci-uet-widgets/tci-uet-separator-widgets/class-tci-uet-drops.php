<?php
/**
 * TCI UET Drops Separator widget class
 *
...
class TCI_UET_Drops extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Drops', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-drops.svg' ); ?></div>
		</div>
		<?php
	}
}
