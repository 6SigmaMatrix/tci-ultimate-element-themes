<?php
/**
 * TCI UET Zig Zag Separator widget class
 *
...
class TCI_UET_Zig_Zag extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET ZigZag', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-zigzag.svg' ); ?></div>
		</div>
		<?php
	}
}
