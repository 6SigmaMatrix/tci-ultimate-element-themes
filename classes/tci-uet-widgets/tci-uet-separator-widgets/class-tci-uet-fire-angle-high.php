<?php
/**
 * TCI UET FIre Angle High Separator widget class
 *
...
class TCI_UET_Fire_Angle_High extends Widget_Base {
	...
	public function get_name() {
		return 'TCI_UET_Fire_Angle_High';
	}
	...
	public function get_title() {
		return __( 'TCI UET Fire Angle High', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-fire-angle-high.svg' ); ?></div>
		</div>
		<?php
	}
}
