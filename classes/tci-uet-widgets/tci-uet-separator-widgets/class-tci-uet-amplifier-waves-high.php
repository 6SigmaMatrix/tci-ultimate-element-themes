<?php
/**
 * TCI UET Amplifier Waves High Separator widget class
 *
...
class TCI_UET_Amplifier_Waves_High extends Widget_Base {
	...
	public function get_name() {
		return 'TCI_UET_Amplifier_Waves_High';
	}
	...
	public function get_title() {
		return __( 'TCI UET Amplifier Waves High', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-amplifier-waves-high.svg' ); ?></div>
		</div>
		<?php
	}
}
