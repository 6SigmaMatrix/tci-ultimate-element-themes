<?php
/**
 * TCI UET Sea Waves Separator widget class
 *
...
class TCI_UET_Sea_Waves extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Sea Waves', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-sea-waves.svg' ); ?></div>
		</div>
		<?php
	}
}
