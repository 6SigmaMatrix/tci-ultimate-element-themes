<?php
/**
 * TCI UET Word Div Separator widget class
 *
...
class TCI_UET_Word_Div extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Word Div', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-word-div.svg' ); ?></div>
		</div>
		<?php
	}
}
