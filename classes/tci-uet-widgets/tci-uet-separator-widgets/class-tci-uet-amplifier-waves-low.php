<?php
/**
 * TCI UET Amplifier Waves Low Separator widget class
 *
...
class TCI_UET_Amplifier_Waves_Low extends Widget_Base {
	...
	public function get_name() {
		return 'TCI_UET_Amplifier_Waves_Low';
	}
	...
	public function get_title() {
		return __( 'TCI UET Amplifier Waves Low', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-amplifier-waves-low.svg' ); ?></div>
		</div>
		<?php
	}
}
