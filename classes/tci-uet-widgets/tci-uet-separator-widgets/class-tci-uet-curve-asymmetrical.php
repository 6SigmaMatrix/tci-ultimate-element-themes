<?php
/**
 * TCI UET Curve Asymmetrical Separator widget class
 *
...
class TCI_UET_Curve_Asymmetrical extends Widget_Base {
	...
	public function get_name() {
		return 'TCI_UET_Curve_Asymmetrical';
	}
	...
	public function get_title() {
		return __( 'TCI UET Curve Asymmetrical', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-curve-asymmetrical.svg' ); ?></div>
		</div>
		<?php
	}
}
