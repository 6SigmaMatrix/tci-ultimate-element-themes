<?php
/**
 * TCI UET Triangle Separator widget class
 *
...
class TCI_UET_Triangle extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Triangle', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-triangle.svg' ); ?></div>
		</div>
		<?php
	}
}
