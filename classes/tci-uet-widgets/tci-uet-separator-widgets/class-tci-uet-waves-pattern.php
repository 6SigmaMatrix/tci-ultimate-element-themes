<?php
/**
 * TCI UET Waves Pattern Separator widget class
 *
...
class TCI_UET_Waves_Pattern extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Waves Pattern', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-waves-pattern.svg' ); ?></div>
		</div>
		<?php
	}
}
