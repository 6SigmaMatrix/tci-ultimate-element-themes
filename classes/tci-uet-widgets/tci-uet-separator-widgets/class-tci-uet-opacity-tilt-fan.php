<?php
/**
 * TCI UET Opacity Tilt Fan Separator widget class
 *
...
class TCI_UET_Opacity_Tilt_Fan extends Widget_Base {
	...
	public function get_name() {
		return 'TCI_UET_Opacity_Tilt_Fan';
	}
	...
	public function get_title() {
		return __( 'TCI UET Opacity Tilt Fan', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-opacity-tilt-fan.svg' ); ?></div>
		</div>
		<?php
	}
}
