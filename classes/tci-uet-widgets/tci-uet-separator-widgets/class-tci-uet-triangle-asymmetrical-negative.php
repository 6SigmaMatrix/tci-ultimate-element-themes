<?php
/**
 * TCI UET Triangle Asymmetrical Negative Separator widget class
 *
...
class TCI_UET_Triangle_Asymmetrical_Negative extends Widget_Base {
	...
	public function get_name() {
		return 'TCI_UET_Triangle_Asymmetrical_Negative';
	}
	...
	public function get_title() {
		return __( 'TCI UET Triangle Asymmetrical Negative', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-triangle-asymmetrical-negative.svg' ); ?></div>
		</div>
		<?php
	}
}
