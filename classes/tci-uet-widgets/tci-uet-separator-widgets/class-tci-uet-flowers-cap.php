<?php
/**
 * TCI UET Flowers Cap Separator widget class
 *
...
class TCI_UET_Flowers_Cap extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Flowers Cap', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-flowers-cap.svg' ); ?></div>
		</div>
		<?php
	}
}
