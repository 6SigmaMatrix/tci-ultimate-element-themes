<?php
/**
 * TCI UET Triangle Fest Separator widget class
 *
...
class TCI_UET_Triangle_Fest extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Triangle Fest', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-triangle-fest.svg' ); ?></div>
		</div>
		<?php
	}
}
