<?php
/**
 * TCI UET Fire Triangle Separator widget class
 *
...
class TCI_UET_Fire_Triangle extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Fire Triangle', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-fire-triangle.svg' ); ?></div>
		</div>
		<?php
	}
}
