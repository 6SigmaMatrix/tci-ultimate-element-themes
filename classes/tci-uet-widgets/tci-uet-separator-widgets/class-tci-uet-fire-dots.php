<?php
/**
 * TCI UET Fire Dots Separator widget class
 *
...
class TCI_UET_Fire_Dots extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET Fire Dots', 'tci-uet' );
	}
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-wrapper' ); ?>>
			<div class="tci-uet-shap-inner"><?php echo tci_uet_shap( 'tci-uet-fire-dots.svg' ); ?></div>
		</div>
		<?php
	}
}
