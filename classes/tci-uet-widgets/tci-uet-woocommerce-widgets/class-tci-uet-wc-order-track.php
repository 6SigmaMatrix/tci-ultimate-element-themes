<?php
/**
 * TCI UET Order Tracing widget class
 *
...
class TCI_UET_WC_Order_Track extends Widget_Base {
	...
	public function get_title() {
		return __( 'TCI UET WC Order Track', 'tci-uet' );
	}
	...
	public function get_keywords() {
		return [ 'order track', 'woocommerce' ];
	}
