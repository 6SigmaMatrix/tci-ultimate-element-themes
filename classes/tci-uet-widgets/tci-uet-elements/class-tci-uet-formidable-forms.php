...
class TCI_UET_Formidable_Forms extends Widget_Base {
	...
	protected function _register_controls() {
		if ( ! function_exists( 'load_formidable_forms' ) ) {
			$this->start_controls_section(
				TCI_UET_SETTINGS . '_formidable_warning',
				[
					'label' => __( 'Warning!', 'tci-uet' ),
				]
			);
			$this->add_control(
				TCI_UET_SETTINGS . '_formidable_warning_text',
				[
		...
		$this->add_control(
			TCI_UET_SETTINGS . '_formidable_id',
			[
	...
	protected function render() {
		...
		echo do_shortcode( '[formidable id="' . $settings->get( TCI_UET_SETTINGS . '_formidable_id' ) . '"]' );
	}
}
