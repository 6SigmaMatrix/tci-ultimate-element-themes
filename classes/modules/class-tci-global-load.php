...
class TCI_Global_Load {
	...
	public function register_documents( $documents_manager ) {
		$documents_manager->register_document_type( self::TEMPLATE_TYPE, TCI_Global_Widget_Library::get_class_full_name() );
	}

	public function on_elementor_editor_init() {
		Plugin::instance()->common->add_template( tci_root( 'inc/templates/elementor-global-panel-view.php' ) );
	}
