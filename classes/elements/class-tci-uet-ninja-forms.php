...
class TCI_UET_Ninja_Forms extends Widget_Base {
	...
	protected function _register_controls() {
		if ( ! function_exists( 'ninja_forms_three_table_exists' ) ) {
			$this->start_controls_section(
				TCI_SETTINGS . '_ninjaform_warning',
				[
					'label' => __( 'Warning!', 'tci-uet' ),
				]
			);
			$this->add_control(
				TCI_SETTINGS . '_ninjaform_warning_text',
				[
	...
	protected function render() {
		...
		echo do_shortcode( '[ninja_form id="' . $settings->get( TCI_SETTINGS . '_ninjaform_id' ) . '" title="false" description="false"]' );
	}
}
