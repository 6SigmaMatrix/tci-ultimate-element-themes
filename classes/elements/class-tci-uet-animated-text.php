...
class TCI_UET_Animated_Text extends Widget_Base {
	...
	protected function _register_controls() {
		$this->start_controls_section(
			TCI_SETTINGS . 'section_title_settings',
			[
	...
	protected function before_text_controls() {
		$this->add_control(
			TCI_SETTINGS . '_section_title_before_hr',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_section_title_before',
			[
	...
	protected function animated_text_controls() {
		$this->add_control(
			TCI_SETTINGS . '_section_animated_title_hr',
			[
				'type' => Controls_Manager::DIVIDER,
			]
		);
		...
		$this->add_control(
			TCI_SETTINGS . '_section_animated_title',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_animated_title_list',
			[
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeat->get_controls(),
				'default'     => [
					[
						TCI_SETTINGS . '_animated_title' => __( 'Designer', 'tci-uet' ),
					],
					[
						TCI_SETTINGS . '_animated_title' => __( 'Developer', 'tci-uet' ),
					],
					[
						TCI_SETTINGS . '_animated_title' => __( 'Awesome', 'tci-uet' ),
					],
				],
				'title_field' => '{{{ ' . TCI_SETTINGS . '_animated_title }}}',
			]
		);
	}
	...
	protected function after_text_controls() {
		$this->add_control(
			TCI_SETTINGS . '_section_title_after_hr',
			[
				'type' => Controls_Manager::DIVIDER,
			]
		);
		...
		$this->add_control(
			TCI_SETTINGS . '_section_title_after',
			[
	...
	protected function js_controls() {
		$this->start_controls_section(
			TCI_SETTINGS . '_section_title_js',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_animation_t_speed',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_animation_d_speed',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_animation_k_speed',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_animation_n_s_delay',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_animation_s_delay',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_animation_life_like',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_animation_cursor',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_animation_break_lines',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_animation_s_Delete',
			[
	...
	protected function style_controls() {
		$this->start_controls_section(
			TCI_SETTINGS . '_section_title_style',
			[
				'label' => __( 'Text', 'elementor' ),
		...
		$this->add_group_control(
			...
			[
				'name'     => TCI_SETTINGS . '_text_shadow',
				'selector' => '{{WRAPPER}} .tci-uet-widget .elementor-heading-title',
			]
		);

		$this->add_control(
			TCI_SETTINGS . '_blend_mode',
			[
		...
		$this->start_controls_section(
			TCI_SETTINGS . '_section_animate_title_style',
			[
				'label' => __( 'Animated Text', 'elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		...
		$this->add_control(
			TCI_SETTINGS . '_animate_title_color',
			[
				'label'     => __( 'Text Color', 'elementor' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => [
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => TCI_SETTINGS . '_animate_title_typography',
				'scheme'   => Scheme_Typography::TYPOGRAPHY_1,
		...
		$this->add_group_control(
			Group_Control_Text_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_animate_title_text_shadow',
				'selector' => '{{WRAPPER}} .tci-uet-widget .tci-uet-animated-text',
			]
		);

		$this->add_control(
			TCI_SETTINGS . '_animate_title_blend_mode',
			[
				'label'     => __( 'Blend Mode', 'elementor' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
	...
	protected function render() {
		...
		if ( ! empty( $settings->get( TCI_SETTINGS . '_size' ) ) ) {
			$this->add_render_attribute( 'tci-uet-text-title', 'class', 'elementor-size-' . $settings->get( TCI_SETTINGS . '_size' ) );
		}

		$this->add_inline_editing_attributes( 'title' );

		$title_before   = $settings->get( TCI_SETTINGS . '_title_before' );
		$title_animated = $settings->get( TCI_SETTINGS . '_animated_title_list.0.' . TCI_SETTINGS . '_animated_title' );
		$title_after    = $settings->get( TCI_SETTINGS . '_title_after' );
		?>
		<div <?php echo $this->get_render_attribute_string( 'tci-uet-text-wrapper' ); ?>>
			...
			$title_html = sprintf(
				...
				$settings->get( TCI_SETTINGS . '_header_size' ),
		...
		$title_animated = '';
		foreach ( $settings->get( TCI_SETTINGS . '_animated_title_list' ) as $t ) {
			$title_animated .= '"' . $t->get( TCI_SETTINGS . '_animated_title' ) . '",';
		}

		$speed           = tci_get_have( $settings, TCI_SETTINGS . '_animation_t_speed' ) ? $settings->get( TCI_SETTINGS . '_animation_t_speed' ) : '1000';
		$deleteSpeed     = tci_get_have( $settings, TCI_SETTINGS . '_animation_d_speed' ) ? $settings->get( TCI_SETTINGS . '_animation_d_speed' ) : '100';
		$lifeLike        = tci_get_have( $settings, TCI_SETTINGS . '_animation_life_like' ) ? $settings->get( TCI_SETTINGS . '_animation_life_like' ) : 'false';
		$cursor          = tci_get_have( $settings, TCI_SETTINGS . '_animation_cursor' ) ? $settings->get( TCI_SETTINGS . '_animation_cursor' ) : 'false';
		$cursorSpeed     = tci_get_have( $settings, TCI_SETTINGS . '_animation_k_speed' ) ? $settings->get( TCI_SETTINGS . '_animation_k_speed' ) : '1000';
		$breakLines      = tci_get_have( $settings, TCI_SETTINGS . '_animation_break_lines' ) ? $settings->get( TCI_SETTINGS . '_animation_break_lines' ) : 'false';
		$nextStringDelay = tci_get_have( $settings, TCI_SETTINGS . '_animation_n_s_delay' ) ? $settings->get( TCI_SETTINGS . '_animation_n_s_delay' ) : '720';
		$startDelay      = tci_get_have( $settings, TCI_SETTINGS . '_animation_s_Delete' ) ? $settings->get( TCI_SETTINGS . '_animation_s_Delete' ) : 'false';
		$loop            = tci_get_have( $settings, TCI_SETTINGS . '_animation_loop' ) ? $settings->get( TCI_SETTINGS . '_animation_loop' ) : 'false';
		$loopDelay       = tci_get_have( $settings, TCI_SETTINGS . '_animation_s_Delete' ) ? $settings->get( TCI_SETTINGS . '_animation_s_Delete' ) : '100';
