...
class TCI_UET_Caldera_Forms extends Widget_Base {
	...
	protected function _register_controls() {
		if ( ! function_exists( 'caldera_forms_load' ) ) {
			$this->start_controls_section(
				TCI_SETTINGS . '_caldera_warning',
				[
					'label' => __( 'Warning!', 'tci-uet' ),
				]
			);
			$this->add_control(
				TCI_SETTINGS . '_caldera_warning_text',
				[
	...
	protected function render() {
		...
		echo do_shortcode( '[caldera_form id="' . $settings->get( TCI_SETTINGS . '_caldera_id' ) . '"]' );
	}
}
