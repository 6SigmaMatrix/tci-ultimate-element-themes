...
class TCI_UET_Contact_Form_7 extends Widget_Base {
	...
	protected function _register_controls() {
		if ( ! function_exists( 'wpcf7' ) ) {
			$this->start_controls_section(
				TCI_SETTINGS . '_contactform7_warning',
				[
					'label' => __( 'Warning!', 'tci-uet' ),
				]
			);
			$this->add_control(
				TCI_SETTINGS . '_contactform7_warning_text',
				[
	...
	protected function get_forms_list() {
		...
		$this->add_control(
			TCI_SETTINGS . '_contact_form_7_slug',
			[
				'label'   => __( 'Forms List', 'tci-uet' ),
				'type'    => Controls_Manager::SELECT,
				'options' => tci_get_post_list( 'wpcf7_contact_form' ),
	...
	protected function get_forms_label_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_label_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_label_width',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_label_margin',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_label_padding',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_contactform7_label_normal_bg',
			[
		...
		$this->add_group_control(
			...
			[
				'name'     => TCI_SETTINGS . '_contactform7_label_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form label',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_label_radius',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_contactform7_label_typography_color',
			[
		...
		$this->add_group_control(
			...
			[
				'name'     => TCI_SETTINGS . '_contactform7_label',
	...
	protected function get_forms_text_settings() {
		...
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_text_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_text_input_text_indent',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_text_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_text_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_text_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_text_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_text_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_text_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_text_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="text"]',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_text_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_text_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="text"]',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_text_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_text_input_bg_focus',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_text_input_border_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="text"]:focus',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_text_input_radius_focus',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_text_input_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="text"]:focus',
			]
		);
		$this->end_controls_tab();
	...
	protected function get_forms_email_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_emal_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_email_input_text_indent',
			[
				'label'      => __( 'Text Indent', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_email_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_email_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_email_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_email_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_email_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_email_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_email_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="email"]',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_email_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_email_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="email"]',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_email_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_email_input_bg_focus',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_email_input_border_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="email"]:focus',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_email_input_radius_focus',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_email_input_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="email"]:focus',
			]
		);
		$this->end_controls_tab();
	...
	protected function get_forms_url_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_url_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_url_input_text_indent',
			[
				'label'      => __( 'Text Indent', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_url_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_url_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_url_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_url_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_url_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_url_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_url_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="url"]',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_url_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_url_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="url"]',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_url_normal_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_url_input_bg_focus',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_url_input_border_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="url"]:focus',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_url_input_radius_focus',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_url_input_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="url"]:focus',
			]
		);
		$this->end_controls_tab();
	...
	protected function get_forms_tel_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_tel_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_tel_input_text_indent',
			[
				'label'      => __( 'Text Indent', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_tel_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_tel_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_tel_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_tel_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_tel_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_tel_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_tel_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="tel"]',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_tel_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_tel_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="tel"]',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_tel_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_tel_input_bg_focus',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_tel_input_border_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="tel"]:focus',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_tel_input_radius_focus',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_tel_input_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="tel"]:focus',
			]
		);
		$this->end_controls_tab();
	...
	protected function get_forms_number_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_number_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_number_input_text_indent',
			[
				'label'      => __( 'Text Indent', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_number_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_number_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_number_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_number_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_number_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_number_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_number_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="number"]',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_number_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_number_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="number"]',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_number_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_number_input_bg_focus',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_number_input_border_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="number"]:focus',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_number_input_radius_focus',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_number_input_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="number"]:focus',
			]
		);
		$this->end_controls_tab();
	...
	protected function get_forms_date_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_date_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_date_input_text_indent',
			[
				'label'      => __( 'Text Indent', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_date_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_date_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_date_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_date_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_date_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_date_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_date_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="date"]',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_date_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_date_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="date"]',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_date_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_date_input_bg_focus',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_date_input_border_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="date"]:focus',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_date_input_radius_focus',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_date_input_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="date"]:focus',
			]
		);
		$this->end_controls_tab();
	...
	protected function get_forms_textarea_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_textarea_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_textarea_input_text_indent',
			[
				'label'      => __( 'Text Indent', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_textarea_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_textarea_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_textarea_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_textarea_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_textarea_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_textarea_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_textarea_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form textarea',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_textarea_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_textarea_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form textarea',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_textarea_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_textarea_input_bg_focus',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_textarea_input_border_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form textarea:focus',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_textarea_input_radius_focus',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_textarea_input_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form textarea:focus',
			]
		);
		$this->end_controls_tab();
	...
	protected function get_forms_select_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_select_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_select_input_text_indent',
			[
				'label'      => __( 'Text Indent', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_select_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_select_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_select_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_select_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_select_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_select_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_select_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form select',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_select_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_select_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form select',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_select_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_select_input_bg_focus',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_select_input_border_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form select:focus',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_select_input_radius_focus',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_select_input_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form select:focus',
			]
		);
		$this->end_controls_tab();
	...
	protected function get_forms_checkbox_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_checkbox_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_checkbox_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_checkbox_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_checkbox_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_checkbox_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="checkbox"]',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_checkbox_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_checkbox_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="checkbox"]',
			]
		);
		$this->end_controls_section();
	...
	protected function get_forms_radio_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_radio_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_radio_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_radio_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_radio_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_radio_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="radio"]',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_radio_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_radio_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="radio"]',
			]
		);
		$this->end_controls_section();
	...
	protected function get_forms_file_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_file_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_file_input_text_indent',
			[
				'label'      => __( 'Text Indent', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_file_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_file_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_file_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_file_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_file_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_file_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_file_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="file"]',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_file_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_file_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="file"]',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_file_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_file_input_bg_focus',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_file_input_border_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="file"]:focus',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_file_input_radius_focus',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_file_input_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="file"]:focus',
			]
		);
		$this->end_controls_tab();
	...
	protected function get_forms_submit_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_button_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_button_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_button_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_button_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_button_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_button_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_button_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			TCI_SETTINGS . '_contactform7_button_typography_color',
			[
				'label'     => __( 'Text Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_button_input_border',
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_button_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_button_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="submit"], {{WRAPPER}} .tci-uet-widget form.wpcf7-form button[type="submit"]',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_button_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_button_input_bg_focus',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			TCI_SETTINGS . '_contactform7_button_typography_color_focus',
			[
				'label'     => __( 'Text Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_button_input_border_focus',
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_button_input_radius_focus',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_button_input_focus',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="submit"]:focus, {{WRAPPER}} .tci-uet-widget form.wpcf7-form button[type="submit"]:focus',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_button_hover',
			[
				'label' => __( 'Hover', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_button_input_bg_hover',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			TCI_SETTINGS . '_contactform7_button_typography_color_hover',
			[
				'label'     => __( 'Text Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => [
		...
		$this->add_control(
			TCI_SETTINGS . '_contactform7_button_input_border_hover',
			[
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_button',
				'scheme'   => Scheme_Typography::TYPOGRAPHY_3,
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form input[type="submit"], {{WRAPPER}} .tci-uet-widget form.wpcf7-form button[type="submit"]',
	...
	protected function get_forms_field_typo_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_field_typography_settings',
			[
				'label' => __( 'Fields Typography', 'tci-uet' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->start_controls_tabs( TCI_SETTINGS . '_contactform7_field_typography_tabs' );
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_field_typography_normal',
			[
				'label' => __( 'Normal', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_field_typography_color',
			[
				'label'     => __( 'Text Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => [
		...
		$this->end_controls_tab();
		$this->start_controls_tab(
			TCI_SETTINGS . '_contactform7_field_typography_focus',
			[
				'label' => __( 'Focus', 'tci-uet' ),
			]
		);
		$this->add_control(
			TCI_SETTINGS . '_contactform7_field_typography_color_focus',
			[
				'label'     => __( 'Text Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => [
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_field',
				'scheme'   => Scheme_Typography::TYPOGRAPHY_3,
	...
	protected function get_forms_error_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_error_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_error_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_error_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_error_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_control(
			TCI_SETTINGS . '_contactform7_error_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			TCI_SETTINGS . '_contactform7_error_typography_color',
			[
				'label'     => __( 'Text Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_error_input_border',
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_error_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_error_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form span.wpcf7-not-valid-tip, {{WRAPPER}} .tci-uet-widget form.wpcf7-form .wpcf7-validation-errors',
			]
		);
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_error',
				'scheme'   => Scheme_Typography::TYPOGRAPHY_3,
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form span.wpcf7-not-valid-tip, {{WRAPPER}} .tci-uet-widget form.wpcf7-form .wpcf7-validation-errors',
	...
	protected function get_forms_thank_settings() {
		$this->start_controls_section(
			TCI_SETTINGS . '_contactform7_input_done_settings',
			[
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_done_input_width',
			[
				'label'      => __( 'Width', 'tci-uet' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_done_input_margin',
			[
				'label'      => __( 'Margin', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_done_input_padding',
			[
				'label'      => __( 'Padding', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_control(
			TCI_SETTINGS . '_contactform7_done_input_bg',
			[
				'label'     => __( 'Background Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			TCI_SETTINGS . '_contactform7_done_typography_color',
			[
				'label'     => __( 'Text Color', 'tci-uet' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => [
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_done_input_border',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form .wpcf7-mail-sent-ok',
			]
		);
		$this->add_responsive_control(
			TCI_SETTINGS . '_contactform7_done_input_radius',
			[
				'label'      => __( 'Border Radius', 'tci-uet' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_done_input',
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form .wpcf7-mail-sent-ok',
			]
		);
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => TCI_SETTINGS . '_contactform7_done',
				'scheme'   => Scheme_Typography::TYPOGRAPHY_3,
				'selector' => '{{WRAPPER}} .tci-uet-widget form.wpcf7-form .wpcf7-mail-sent-ok',
	...
	protected function render() {
		...
		$post = get_page_by_path( $settings->get( TCI_SETTINGS . '_contact_form_7_slug' ), OBJECT, 'wpcf7_contact_form' );
