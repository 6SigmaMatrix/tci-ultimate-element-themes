...
class TCI_UET_Revolution_Slider extends Widget_Base {
	...
	protected function _register_controls() {
		if ( ! class_exists( 'RevSliderFront' ) ) {
			$this->start_controls_section(
				TCI_SETTINGS . '_revolution_slider_warning',
				[
					'label' => __( 'Warning!', 'tci-uet' ),
				]
			);
			$this->add_control(
				TCI_SETTINGS . '_revolution_slider_warning_text',
				[
		 ...
		 */
		$this->start_controls_section(
			TCI_SETTINGS . '_revolution_slider',
			[
		...
		$this->add_control(
			TCI_SETTINGS . '_revolution_slider_slug',
			[
	...
	protected function render() {
		...
		echo do_shortcode( '[rev_slider alias="' . $settings->get( TCI_SETTINGS . '_revolution_slider_slug' ) . '"]' );
	}
}
