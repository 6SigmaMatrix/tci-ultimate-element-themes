...
class TCI_UET_Global_Widget extends Widget_Base {
	/**
	 * @var Widget_Base
	 */
	...
	public function __construct( $data = [], $args = null ) {
		if ( $data ) {
			...
			if ( ! empty( $data['previewSettings'] ) && ( is_preview() || Plugin::instance()->preview->is_preview_mode() ) ) {
	...
	public function get_title() {
		return __( 'TCI UET Global', 'tci-uet' );
	}
