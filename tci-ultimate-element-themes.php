 ...
 * @since  0.0.4
 */
function tci_admin_notice_missing_main_plugin() {
...
if ( ! did_action( 'elementor/loaded' ) ) {
	add_action( 'admin_notices', 'tci_admin_notice_missing_main_plugin' );
 ...
 * @since  0.0.1
 */
define( 'TCI_SETTINGS', 'tci_settings' );
...
function tci_uet_plugin_loaded_action() {
	require tci_root( 'tci-loader.php' );
}
